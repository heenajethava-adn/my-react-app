function Sidebar(){
    return (
      <aside className="z-20 border  flex-shrink-0 hidden w-64 overflow-y-auto bg-white  md:block">
        <div className="py-4 text-gray-500">
          <div className="flex justify-center">
            <a
              className="text-2xl font-bold tracking-wider italic text-teal-600 capitalize"
              href="#"
            >
              event
            </a>
            <a
              className="text-2xl font-bold tracking-wider text-gray-600 capitalize"
              href="#"
            >
              AURA
            </a>
          ...
          <ul>
            ...
            <li className="relative px-6 py-3">
              ...
              >
                ...
                <span className="ml-4">Venues</span>
              </a>
            </li>
            <li className="relative px-6 py-3">
              <a
            ...
            <li className="relative px-6 py-3">
              ...
              >
                ...
                <span className="ml-4">Team Members</span>
              </a>
            </li>
            <li className="relative px-6 py-3">
              <a
              ...
              >
                ...
                <span className="ml-4">Assigned Tasks</span>
              </a>
            </li>
            <li className="relative px-6 py-3">
              <a
